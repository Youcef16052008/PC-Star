...
- Master: credentials come from `MASTER_EMAIL` / `MASTER_PASSWORD` (never hardcoded, never published). Desk: toggle/add paneaux, add/hide products, delete customers, see pickup list. Cannot be deleted.
