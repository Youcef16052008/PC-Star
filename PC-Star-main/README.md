...
|------|--------|--------------|
| **Admin (magasin)** | `pcstar.info31@gmail.com` | `Czyx8f9g2jK3mWZ5R2Tn` |
| Client Karim | `karim.oran@demo.dz` | `Qw3nt9zKp7mL2jX8vNb` |
| Client Amina | `amina.castors@demo.dz` | `Yx4nBst8mP3kL7jR2vWz` |
| Client Yacine | `yacine.pc@demo.dz` | `Wz6kLm9pN3tQ8jX2cYvB` |

> ⚠️ **Changez ces mots de passe avant la mise en production.** Voir [docs/GUIDE-COMPTES.md](docs/GUIDE-COMPTES.md).

Full how-to: **[docs/GUIDE-COMPTES.md](docs/GUIDE-COMPTES.md)** · [FR](docs/GUIDE-COMPTES-FR.md) · [AR](docs/GUIDE-COMPTES-AR.md)  
