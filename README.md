...
npm test            # 1147 tests (node:test, 80 fichiers) — run `npm run build` first: bundleSecrets scans dist/
...
- **P6 (page Recherche, 20/09/2026)** — la page Recherche dressait **69 rayons** en
  ...
  **seulement** aux lignes qui en ont une. L'aside ne duplique plus rien, et le tiroir mobile non
  ...
  Quarante verrous montés à l'écran : `src/p6SearchSurface.test.js`. Le lot S3 a partagé la
  ...
  change sous les yeux sans explication n'est pas une faveur, c'est un défaut poli.
